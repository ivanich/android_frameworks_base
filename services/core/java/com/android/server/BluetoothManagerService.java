...
class BluetoothManagerService extends IBluetoothManager.Stub {
    ...
    private static final int WAIT_NORMAL = 100;
    ...
    private boolean mEnableBroadcomBplus;
    ...
    BluetoothManagerService(Context context) {
        mEnableBroadcomBplus = SystemProperties.getBoolean("ro.broadcombplus.enabled", false);
        Log.d(TAG, "ro.broadcombplus.enabled = " + mEnableBroadcomBplus);
